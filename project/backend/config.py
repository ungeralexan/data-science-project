...
IMAGE_KEY_DESCRIPTIONS = {
    ...
    # --- Environment (topic) ---
    "climate": "Use for climate change specifically: emissions, mitigation/adaptation, climate policy/science. Prefer climate over sustainability when climate change is explicitly named or the main framing. Exclude general sustainability/ESG/circular economy topics -> use sustainability.",
    "sustainability": "Use for sustainability broadly: ESG, circular economy, resource conservation, sustainable campus/lifestyle. Exclude climate-science/policy focus -> use climate. Prefer sustainability over climate when the framing is general sustainability without climate-change focus.",
